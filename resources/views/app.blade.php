...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/includes/css/maps/jquery-jvectormap-2.0.3.css" />
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                ...
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Банк ВКР!</span></a>
                </div>
...
<!-- tags -->
<script src="/includes/js/tags/jquery.tagsinput.min.js"></script>
<!-- switchery -->
<script src="/includes/js/switchery/switchery.min.js"></script>
<!-- daterangepicker -->
<script type="text/javascript" src="/includes/js/moment/moment.min.js"></script>
<script type="text/javascript" src="/includes/js/datepicker/daterangepicker.js"></script>
<!-- richtext editor -->
<script src="/includes/js/editor/bootstrap-wysiwyg.js"></script>
<script src="/includes/js/editor/external/jquery.hotkeys.js"></script>
<script src="/includes/js/editor/external/google-code-prettify/prettify.js"></script>
<!-- select2 -->
<script src="/includes/js/select/select2.full.js"></script>
<!-- form validation -->
<script type="text/javascript" src="/includes/js/parsley/parsley.min.js"></script>
<!-- textarea resize -->
<script src="/includes/js/textarea/autosize.min.js"></script>
<script>
    autosize($('.resizable_textarea'));
</script>
<!-- Autocomplete -->
<script type="text/javascript" src="/includes/js/autocomplete/countries.js"></script>
